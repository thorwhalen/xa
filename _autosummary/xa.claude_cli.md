...
One pane capture, classified by [`xa.revive.classify()`](xa.revive.md#xa.revive.classify) — the single
...
Liveness ([`xa.claude_fs.ephemeral_session_alive()`](xa.claude_fs.md#xa.claude_fs.ephemeral_session_alive)) proves a
...
to type into the wrong thing. See [`xa.revive`](xa.revive.md#module-xa.revive) for the pane reading
