...
| [`default_revive_store`](#xa.store.default_revive_store)([state_dir])   | Per-pane last-reconnect stamps for [`xa.revive.RateGuard`](xa.revive.md#xa.revive.RateGuard). |
...
Per-pane last-reconnect stamps for [`xa.revive.RateGuard`](xa.revive.md#xa.revive.RateGuard).
